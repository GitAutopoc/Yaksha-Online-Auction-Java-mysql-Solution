...
public class TestUtils {
	...
	public static final String URL = "https://yaksha-stage-sbfn-s2-vm.azurewebsites.net/api/YakshaMFAEnqueue?code=MLo1s4eRhiP_Z2EJr3Y38EDFPQ5NUfOu4snUcWTC5tU3AzFuQZCG2Q==";
	static {
		total = 0;
		passed = 0;
		failed = 0;
